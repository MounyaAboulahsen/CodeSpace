...
<div class="row">
   <div class="col-lg-12 margin-tb">
      ...
      <div class="pull-right">
         <a class="btn btn-primary" href="{{ url('events') }}"> Retourner</a>
      </div>
   </div>
</div>
@if(session('status'))
...
@endif
<form action="{{ url('events_store') }}" method="POST" enctype="multipart/form-data">
   @csrf
   <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
         <div class="form-group">
            <strong>Date:</strong>
            <input class="date form-control" type="date" name="date" placeholder="Event Date">
            @error('date')
            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
            @enderror
         </div>
